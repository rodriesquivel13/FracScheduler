...
def index():
    ...
    unfractional_dates      = unfractional_dates_list(year, internal_start)
...
def hunt_fraction():
    ...
    unfractional_dates      = unfractional_dates_list(wishful_date.year, internal_start)
